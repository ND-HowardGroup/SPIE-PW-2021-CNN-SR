...
test_type = 1
CSV_path = '/afs/crc.nd.edu/user/v/vmannam/Desktop/Summer20/May20/1905/VM_6/'
class DataGenerator(data.Dataset):
    ...
    def __data_generation(self, list_IDs_temp):
        ...
        if self.train == True and self.validation == False and self.test == False:
            df = pandas.read_csv(CSV_path + 'samples_train_all_large_dataset.csv')
...
ckpt_dir = '/afs/crc.nd.edu/user/v/vmannam/Desktop/Summer20/May20/1905/VM_6/saved_model/'
#train function
...
if __name__ == "__main__":
    ...
    path = '/afs/crc.nd.edu/user/v/vmannam/Desktop/Summer20/May20/1905/VM_6/'
