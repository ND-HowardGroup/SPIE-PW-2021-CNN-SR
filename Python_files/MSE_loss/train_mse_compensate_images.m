...
lr1 = load('DenseED_train_RMSE_0602_2021_20210206_192659_vm41.txt'); %new result with VM4 SR result MSE 
lr2 = load('DenseED_train_RMSE_0602_2021_20210206_200818_vm521.txt'); %new result with VM52 SR result MSE 
lr3 = load('DenseED_train_RMSE_0602_2021_20210206_215826_vm6141.txt'); %new result with VM614 SR result MSE 
lr4 = load('DenseED_train_RMSE_0602_2021_20210206_231338_vm6142.txt'); %new result with VM6142 SR result MSE 
lr5 = load('DenseED_train_RMSE_0602_2021_20210206_231249_vm711.txt'); %new result with VM711 SR result MSE 
lr6 = load('DenseED_train_RMSE_0602_2021_20210206_233131_vm712.txt'); %new result with VM712 SR result MSE 

scaling = sqrt(187/100); %batches in 750 over 400 images
lr4 = lr4/scaling;
lr5 = lr5/scaling;
lr6 = lr6/scaling;

lr1 = lr1/10; %to compare with test loss
lr2 = lr2/10; %to compare with test loss
lr3 = lr3/10; %to compare with test loss
lr4 = lr4/10; %to compare with test loss
lr5 = lr5/10; %to compare with test loss
lr6 = lr6/10; %to compare with test loss
